...
#include "ocs2_quadruped_controller/interface/io_interface/IOROS.h"
...
void IOROS::initSend(){
    this->cmd_pub = this->node->create_publisher<control_input_msgs::msg::LeggedCommand>("legged_command", 10);
}

void IOROS::initRecv(){
    this->imu_sub = this->node->create_subscription<control_input_msgs::msg::SimImu>
            ("imu_data", 10, std::bind(&IOROS::imuCallback, this, std::placeholders::_1));
    this->state_sub = this->node->create_subscription<control_input_msgs::msg::SimJoint>
            ("joint_data", 10, std::bind(&IOROS::jointStateCallback, this, std::placeholders::_1));
}

void IOROS::imuCallback(const control_input_msgs::msg::SimImu & msg)
{
...
void IOROS::jointStateCallback(const control_input_msgs::msg::SimJoint & msg)
{
    // fl
