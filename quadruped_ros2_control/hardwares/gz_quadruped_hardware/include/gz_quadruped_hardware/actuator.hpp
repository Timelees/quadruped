...
#ifndef _ACTUATOR__HPP__
#define _ACTUATOR__HPP__
...
namespace gazebo
{
  ...
  public:
     ...
     */
    Actuator_(const double &n1 = 11.52, const double &n2 = 29.32, const double &n3 = 60.0, const double &tau_max = 12.001,  
